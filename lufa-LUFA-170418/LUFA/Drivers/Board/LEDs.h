...
#define __LEDS_H__
	...
	/* Macros: */
		...
		#define LEDS16_LED1        (1 << 5)

		/** LED mask for the second LED on the board. */
		#define LEDS16_LED2        (1 << 0)

		/** LED mask for the third LED on the board. */
		#define LEDS16_LED3        (1 << 1)	
		
		/** LED mask for the third LED on the board. */
		#define LEDS16_LED4        (1 << 3)	
		
		/** LED mask for the third LED on the board. */
		#define LEDS16_LED5        (1 << 2)	
	...
	/* Includes: */
		...
		#elif (BOARD == BOARD_MZB)
			#include "AVR8/MZB/LEDs.h"
		#else
